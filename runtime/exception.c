...
void Cilk_exception_handler() {
    ...
    __cilkrts_alert(3, "[%d]: (Cilk_exception_handler) closure %p!\n", ws->self, t);
    ...
    if( ws->head > ws->tail ) {
      ...
      __cilkrts_alert(3, "[%d]: (Cilk_exception_handler) this is a steal!\n", ws->self);
    ...
    if (t->left_sib || t->spawn_parent->fiber_child) {
      ...
      __cilkrts_alert(3, "[%d]: (Cilk_exception_handler) we are not the leftmost stack.\n", ws->self);
      ...
      __cilkrts_alert(3, "[%d]: (Cilk_exception_handler) we are the leftmost stack!\n", ws->self);
